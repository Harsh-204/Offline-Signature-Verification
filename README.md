...
Download the **CEDAR Signature Dataset** (55 writers, 24 genuine + 24 forged signatures each) and place it under `data/cedar/` as described in [`data/README.md`](file:///d:/Signature%20Verification/data/README.md):
...
### 3. Verify a Single Signature Pair (Demo)
Performs inference on a single pair of images (one genuine reference and one query image to verify).

```bash
sigverify verify --model models/model.pkl --reference data/cedar/full_org/original_1_1.png --query data/cedar/full_forg/forgeries_1_1.png
```
...
=============================================
 Reference Image : data/cedar/full_org/original_1_1.png
 Query Image     : data/cedar/full_forg/forgeries_1_1.png
 Verdict         : FORGED
 Confidence      : 94.20%
=============================================
```
